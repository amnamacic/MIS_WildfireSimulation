...
class FireSimulation:
    def __init__(self):
        ...
        pygame.display.set_caption("Wildfire Spread Simulation - Slow Wind")
        ...
        # Initialize slow wind
        self.wind_direction = random.uniform(0, 2 * math.pi)
        self.wind_strength = SLOW_WIND_STRENGTH
    ...
    def collect_simulation_results(self):
        ...
        time_to_ignition = pygame.time.get_ticks() - self.fire_start_time
